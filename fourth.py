...
os.environ["HUGGINGFACE_API_KEY"] = "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"
...
if submit_button or st.session_state['initiated']:
    ...
    if url and not conversation:
        ...
        vectorstore = Weaviate.from_documents(client=client, documents=chunks, embedding=CohereEmbeddings(), by_text=False)
...
st.title("RAG System powered by TruLens and Cohere")
