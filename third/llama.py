...
workflow_url = "https://clarifai.com/sanjana/Llama-2-Tutorial-Workshop/workflows/workflow-ce09fa"
text_classfication_workflow = Workflow(
    url= workflow_url , pat="97c588ce49174c75b9fd04decc511f72"
)
...
PAT = "97c588ce49174c75b9fd04decc511f72"
# Specify the correct user_id/app_id pairings
# Since you're making inferences outside your app's scope
USER_ID = st.secrets.USER_ID
APP_ID = st.secrets.APP_ID
# Change these to whatever model and text URL you want to use
WORKFLOW_ID = 'workflow-ce09fa'
